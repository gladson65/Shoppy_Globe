    ...
    return(
        <>
            <div className="detailsCard w-full mt-40 p-7 h-auto bg-zinc-300 flex flex-col justify-start
                ...
                <img className="w-2/3 lg:w-96 h-96 md:self-start lg:self-start xl:self-start rounded-lg self-center sm:self-center drop-shadow-[0px_-10px_10px_black]" src={images[0]} alt="CoverImage" />        
                ...
                <div className="bg-white w-full self-start py-12 px-5 md:pt-24 lg:py-20 xl:py-20 lg:px-24 xl:px-24 md:px-7 h-auto rounded-lg relative drop-shadow-[0px_10px_10px_black]">
                    ...
                    <h4 className="mb-2 mt-5 xl:mt-0 "><span className="text-green-500">Warranty Information</span> - {warrantyInformation}</h4>
